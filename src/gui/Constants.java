...
public class Constants {
    ...
    public static final Dimension boardSize = new Dimension(25*2*LogicManager.getBoardSize() + 2 * offSet,
                                                            25*2*LogicManager.getBoardSize() + 2 * offSet);
	...
	public static final Color black = new Color(0, 0, 0); //here is the color used for good points to use for the player.
